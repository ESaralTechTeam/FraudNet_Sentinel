...
class ComplaintDB:
    ...
    def create(data: dict) -> str:
        ...
        """, (
            ...
            'submitted',
            data['description'],
            data.get('subject_beneficiary_id'),
            json.dumps(data['location']),
            data.get('urgency_score', 0.5),
